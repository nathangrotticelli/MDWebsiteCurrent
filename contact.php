<?php
	...
	require_once "Mail.php";  $from = "nathan g <nathangrotticelli@gmail.com>"; $to = "nathan g22 <nmg2225@yahoo.com>"; $subject = "Hi!"; $body = "Hi,\n\nHow are you?";  $host = "mail.google.com"; $username = "nathangrotticelli@gmail.com"; $password = "Housetrap123";  $headers = array ('From' => $from,   'To' => $to,   'Subject' => $subject); $smtp = Mail::factory('smtp',   array ('host' => $host,     'auth' => true,     'username' => $username,     'password' => $password));  $mail = $smtp->send($to, $headers, $body);  if (PEAR::isError($mail)) {   echo("<p>" . $mail->getMessage() . "</p>");  } else {   echo("<p>Message successfully sent!</p>");  }
